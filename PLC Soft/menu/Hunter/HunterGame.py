import pygame, sys
from  HunterShield import HunterShield
from random import randrange
from  HunterPlayer import HunterPlayer
...
class HunterGame():
    ...
    def sterowanie_oknem(self,player,shield):
        if pygame.key.get_pressed()[pygame.K_q]or GPIO.input(32) == 0:
            menu.games()
        if pygame.key.get_pressed()[pygame.K_r]or GPIO.input(33) == 0:
            player.counter_a = 1
            player.zycia_ = 3
            player.punkty_ = 0
            player.x_ = 240
    ...
    def __init__(self):
        ...
        player = HunterPlayer(screen)
        shield = HunterShield(screen)
        heart=Heart(screen)
